...
<div id="cast" class="content">
    ...
    <div class="row" style="height:100%">
        <div class="col-sm-3" id="sidebar">
            ...
            <div class="person_tag" id="timmy">
                Timmy Chan
            </div>
            <div class="person_tag" id="kristen">
                Kristen Yu-Um
            </div>
        </div>
        <div class="col-sm-9" style="height:100%">
            ...
            <div class="actor" id="timmy_a">
                <div class="row">
                    <div class="col-sm-12 bio">
                        <p><span class="first-word">Darren</span> is a website developer in his early 20s, working overtime to provide for his soon-to-be-born child. He's not sure if he can be a good father; he has a hard enough time being a good husband. No one can say he didn't try, even when his attempts fall short of other's expectations. He loves his wife more than anything in the world. Despite having a solid job, he constantly worries that he won't be able to provide for their family.</p>
                    </div>
                </div>
            </div>
            <div class="actor" id="kristen_a">
                <div class="row">
                    <div class="col-sm-12 bio">
                        <p><span class="first-word">Heidi</span> is the oldest out of six other siblings. She was the first to get married, and now the first to have a child. While she was still dating Darren, she worked as a substitute elementary school teacher. It sparked in her a passion for children; she can't wait to have one of her own. She doesn't understand her husband's worries since there will always be worries in any situation, but she tries her best to calm his fears, reassuring him that everything will be alright. After all, he's not the one going through labor. </p>
                    </div>
                </div>
            </div>
        </div>
